...
const Reviews = () => {
  ...
  const url = `https://pc-parts-co.herokuapp.com/reviews`;
  useEffect(() => {
    (async () => {
  ...
  return (
    <div id="reviews" className="container my-24 px-6 mx-auto">
      <section className="mb-32 text-gray-800 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-x-6 gap-y-6 lg:gap-x-12">
          {reviews?.map((review) => (
